-- Fix lifetime subscription warning display
-- Ensure lifetime subscriptions (one_time prices) don't show transaction warnings
...
BEGIN
  ...
  -- Get the most recent subscription for this user with price info
