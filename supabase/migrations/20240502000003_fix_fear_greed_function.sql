-- Update the Fear & Greed Index function to use real API data and proper logging
...
BEGIN
  ...
  RAISE NOTICE 'Starting Fear & Greed Index update';
...
COMMENT ON FUNCTION public.update_fear_greed_index() IS 'Fetches the current Fear & Greed Index from Alternative.me API and updates the fear_greed_index table. If an entry for today already exists, it will update that entry.'; 