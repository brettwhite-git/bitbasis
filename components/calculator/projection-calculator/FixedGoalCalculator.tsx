              ...
              <>
                ...
                <div className="relative">
                  <Input
                    ...
                    className="pr-16 bg-muted/50 border-input h-12"
                    inputMode="decimal"
                  />
                ...
                {/* Sats Display Field */}
                <div className="relative">
                  <div className="flex items-center rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background h-12">
