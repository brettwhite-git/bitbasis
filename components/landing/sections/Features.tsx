      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {[ 
            ...
            { icon: BarChart, title: "Cost Basis Calculation", description: "Accurately calculate your Bitcoin cost basis using FIFO, LIFO, or HIFO methods (configurable soon).", color: "text-bitcoin-orange" },
            ...
            { icon: Percent, title: "Tax Lot Identification", description: "Track individual Bitcoin purchase lots to optimize for short-term vs. long-term capital gains (advanced feature).", color: "text-bitcoin-orange" },
          ].map((feature, index) => (
